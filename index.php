                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Maximize property efficiency with our intuitive real estate management system. Simplify operations and elevate productivity effortlessly</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p> system facilitates seamless management of rental properties, offering features such as rent collection and maintenance scheduling</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Easily showcase properties with our intuitive listing feature, Seamlessly display details, attract buyers</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Safeguard investments with our integrated legal support in the real estate management system. Ensure compliance, mitigate risks</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>encompass various topics such as property acquisitions, market trends, rental agreements, lease negotiations, property maintenance, tenant issues, legal compliance, financial analysis, and investment strategies.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p> It includes tasks such as verifying lease agreements, reviewing property documentation for compliance, auditing financial records, and ensuring all necessary paperwork is organized and up-to-date</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Obtaining ownership or control of a property or asset.purchasing, leasing, or securing management rights</p>
                        </div>
                    </div>
                </div>
            </div>
